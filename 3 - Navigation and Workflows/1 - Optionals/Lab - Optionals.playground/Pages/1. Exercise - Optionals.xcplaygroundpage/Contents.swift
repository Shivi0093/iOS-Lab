...
// the value of userAge is nil because of the value of the userInputAge
// the Int() is not able to convert the string passed in it which contains a non numeric character so it will give the value as nil
