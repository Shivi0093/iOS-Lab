...
struct User {
    ...
    func disp(){
        print("name: ", userName,",email: ",email,",age: ",age)
    }
...
let user=User(userName: "Shivdev", email: "shivdev2448.be23@chitkara.edu.in", age: 19)
user.disp()
 ...
 */
let user2 = User(userName: "jhon",email: "jhon@gmail.com", age: 27)
